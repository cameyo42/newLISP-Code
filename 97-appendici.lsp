...
+-------------+---------------+--------+-------------------------------------+
| NOME        |  DESCRIZIONE  | SPAZIO | INTERVALLO DI VALORI                 |
+-------------+---------------+--------+-------------------------------------+
| char        | Carattere     | 1 byte | signed: da -128 a 127               |
|             |               |        | unsigned: da 0 a 255                |
+-------------+---------------+--------+-------------------------------------+
| short int   | Intero breve  | 2 byte | signed: da -32768 a 32767           |
|             |               |        | unsigned: da 0 a 65535              |
+-------------+---------------+--------+-------------------------------------+
| int         | Intero        | 4 byte | signed: da -2147483648 a 2147483647 |
|             |               |        | unsigned: da 0 a 4294967295         |
+-------------+---------------+--------+-------------------------------------+
| long int    | Intero lungo  | 4 byte | signed: da -2147483648 a 2147483647 |
|             |               |        | unsigned: da 0 a 4294967295         |
+-------------+---------------+--------+-------------------------------------+
| bool        | Booleano      | 1 byte | true (1) oppure false (0)           |
+-------------+---------------+--------+-------------------------------------+
| float       | Float singola | 4 byte | +/- 3.4e+/- 38 (~7 cifre)           |
|             | precisione    |        |                                     |
+-------------+---------------+--------+-------------------------------------+
| double      | Float doppia  | 8 byte | +/- 1.7e+/- 308 (~15 cifre)         |
|             | precisione    |        |                                     |
+-------------+---------------+--------+-------------------------------------+
| long double | Float lungo   | 8 byte | +/- 1.7e+/- 308 (~15 cifre)         |
+-------------+---------------+--------+-------------------------------------+
